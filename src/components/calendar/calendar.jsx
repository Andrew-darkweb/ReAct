import { Scalendar } from '/Scalendar.js'
const Calendar = () => {
    return (
        <Scalendar>
                ...
                <div className="calendar__block">
                    <div className="calendar__nav">
                        ...
                        <div className="nav__actions">
                            <div className="nav__action" data-action="prev">
                                <svg className='svg' xmlns="http://www.w3.org/2000/svg" width="6" height="11" viewBox="0 0 6 11">
                    ...
                    <div className="calendar__content">
                        <div className="calendar__days-names">
                            <div className="calendar__day-ttl">пн</div>
                            <div className="calendar__day-ttl">вт</div>
                            <div className="calendar__day-ttl">ср</div>
                            <div className="calendar__day-ttl">чт</div>
                            <div className="calendar__day-ttl">пт</div>
                            <div className="calendar__day-ttl -weekend-">сб</div>
                            <div className="calendar__day-ttl -weekend-">вс</div>
                        </div>
